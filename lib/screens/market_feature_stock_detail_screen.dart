...
class _FeaturePriceChartState extends State<_FeaturePriceChart> {
  late Future<List<(DateTime, double)>> _future;
  ...
  Future<List<(DateTime, double)>> _load() {
    return StockPriceService.fetchHistoryDetailed(
      widget.item.ticker,
      widget.item.market,
      range: '3mo',
      interval: '1d',
            ...
            return TweenAnimationBuilder<double>(
              ...
              builder: (context, progress, child) {
                return SizedBox(
                  ...
                  child: CustomPaint(
                    painter: _FeatureLineChartPainter(
                      data: data,
